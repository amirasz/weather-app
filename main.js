...
const msg = $.querySelector(".top-banner .msg");
const list = $.querySelector(".cities");
...
form.addEventListener("submit", e => {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            const icon = `https://images.app.goo.gl/22UBWjehCcTCygNJ6`;
            ...
            const markup = `
                ...
                <figure>
                    <img class='city-icon' src='${icon}' alt='cloud'>
